...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="bo_fx" style="border-bottom: 2px solid #ee2d38;padding-bottom:5px;margin:0">
    	<?php 
			$bpy = 0;
			if($bo_table == "notice") $bpy = -100;
			else if($bo_table == "qa") $bpy = -120;
			else if($bo_table == "free") $bpy = -140;
    		if($bpy < 0) {
    	?>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" class="td_date"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?><span class="txts" style="width:20px;background-position-y:-60px">날짜</span></a></th>
            <th scope="col" class="td_num"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?><span class="txts" style="width:20px;background-position-y:-80px">조회</span></a></th>
...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl" style="height:21px;border:1px solid:dddede">
