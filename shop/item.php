...
<?php
	if($it[ca_id] == 10) {	
?>
	<!--span class="bold red noto" style="font-size:16px;margin-bottom: 5px;display: inline-block">wigglewiggle smart gloves</span>
	<div class="patterns">
		<ul>
			<li id="small1415897967" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415897967"><img src="<?php echo G5_URL; ?>/images/pattern_01.png" width="80" height="75" border="0"></a></li>
			<li id="small1415897864" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415897864"><img src="<?php echo G5_URL; ?>/images/pattern_02.png" width="79" height="75" border="0"></a></li>
			<li id="small1415897970" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415897970"><img src="<?php echo G5_URL; ?>/images/pattern_03.png" width="80" height="75" border="0"></a></li>
			<li id="small1415897977" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415897977"><img src="<?php echo G5_URL; ?>/images/pattern_04.png" width="80" height="75" border="0"></a></li>
			<li id="small1415897979" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415897979"><img src="<?php echo G5_URL; ?>/images/pattern_05.png" width="79" height="75" border="0"></a></li>
			<li id="small1415897981" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415897981"><img src="<?php echo G5_URL; ?>/images/pattern_06.png" width="80" height="75" border="0"></a></li>
			<li id="small1415897972" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415897972"><img src="<?php echo G5_URL; ?>/images/pattern_07.png" width="80" height="75" border="0"></a></li>
			<li id="small1415897974" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415897974"><img src="<?php echo G5_URL; ?>/images/pattern_08.png" width="80" height="75" border="0"></a></li>
			<li id="small1415936023" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415936023"><img src="<?php echo G5_URL; ?>/images/pattern_09.png" width="79" height="75" border="0"></a></li>
			<li id="small1415936020" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415936020"><img src="<?php echo G5_URL; ?>/images/pattern_10.png" width="80" height="75" border="0"></a></li>
			<li id="small1415936012" class="opa03"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415936012"><img src="<?php echo G5_URL; ?>/images/pattern_11.png" width="79" height="75" border="0"></a></li>
			<li id="small1415936015" class="opa03 last"><a href="<?php echo G5_URL; ?>/shop/item.php?it_id=1415936015"><img src="<?php echo G5_URL; ?>/images/pattern_12.png" width="80" height="75" border="0"></a></li>
		</ul>
		<div class="cls"></div>
	</div-->
	...
	$(function() {	
		$('.patterns > ul > li').hover(
			...
			function(){
				if($(this).attr("id") != "small<?=$it_id?>")
					$(this).animate({'opacity':0.2},100);
			}
		);
		$("#small<?=$it_id?>").removeClass("opa03");
	});
	</script>
<?php } ?>						
<div id="sit">
