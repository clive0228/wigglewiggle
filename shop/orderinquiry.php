...
if (!$is_member)
{
    ...
    if ($row['od_id']) {
	    ...
	    alert("등록되지 않은 주문서 번호이거나 비밀번호가 맞지 않습니다. 다시 확인해주세요.");
    }
}
...
<div id="sod_v">
    <div class="bo_fx bottomLineRed2px" style="padding-bottom:5px;margin:0">
		<div style="padding:17px 0 0 5px;float:left"><span class="txts t3" style="background-position-y:-200px">제목</span></div>
    </div>
    <?php
