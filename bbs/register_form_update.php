...
$mb_tel         = trim($_POST['mb_tel_1'])."-".trim($_POST['mb_tel_2'])."-".trim($_POST['mb_tel_3']);
$mb_hp          = trim($_POST['mb_hp_1'])."-".trim($_POST['mb_hp_2'])."-".trim($_POST['mb_hp_3']);
...
$mb_child_count = isset($_POST['mb_child_count'])   ? trim($_POST['mb_child_count']) : "";

$mb_child_1_year = isset($_POST['mb_child_1_year'])   ? trim($_POST['mb_child_1_year']) : "";
$mb_child_2_year = isset($_POST['mb_child_2_year'])   ? trim($_POST['mb_child_2_year']) : "";
$mb_child_3_year = isset($_POST['mb_child_3_year'])   ? trim($_POST['mb_child_3_year']) : "";
$mb_child_4_year = isset($_POST['mb_child_4_year'])   ? trim($_POST['mb_child_4_year']) : "";
$mb_child_5_year = isset($_POST['mb_child_5_year'])   ? trim($_POST['mb_child_5_year']) : "";

$mb_child_1_month = isset($_POST['mb_child_1_month'])   ? trim($_POST['mb_child_1_month']) : "";
$mb_child_2_month = isset($_POST['mb_child_2_month'])   ? trim($_POST['mb_child_2_month']) : "";
$mb_child_3_month = isset($_POST['mb_child_3_month'])   ? trim($_POST['mb_child_3_month']) : "";
$mb_child_4_month = isset($_POST['mb_child_4_month'])   ? trim($_POST['mb_child_4_month']) : "";
$mb_child_5_month = isset($_POST['mb_child_5_month'])   ? trim($_POST['mb_child_5_month']) : "";

$mb_child_1_day = isset($_POST['mb_child_1_day'])   ? trim($_POST['mb_child_1_day']) : "";
$mb_child_2_day = isset($_POST['mb_child_2_day'])   ? trim($_POST['mb_child_2_day']) : "";
$mb_child_3_day = isset($_POST['mb_child_3_day'])   ? trim($_POST['mb_child_3_day']) : "";
$mb_child_4_day = isset($_POST['mb_child_4_day'])   ? trim($_POST['mb_child_4_day']) : "";
$mb_child_5_day = isset($_POST['mb_child_5_day'])   ? trim($_POST['mb_child_5_day']) : "";

$mb_child_1_sex = isset($_POST['mb_child_1_sex'])   ? trim($_POST['mb_child_1_sex']) : "";
$mb_child_2_sex = isset($_POST['mb_child_2_sex'])   ? trim($_POST['mb_child_2_sex']) : "";
$mb_child_3_sex = isset($_POST['mb_child_3_sex'])   ? trim($_POST['mb_child_3_sex']) : "";
$mb_child_4_sex = isset($_POST['mb_child_4_sex'])   ? trim($_POST['mb_child_4_sex']) : "";
$mb_child_5_sex = isset($_POST['mb_child_5_sex'])   ? trim($_POST['mb_child_5_sex']) : "";
...
if ($w == '') {
    ...
    $sql = " insert into {$g5['member_table']}
                set mb_id = '{$mb_id}',
                     ...
                     mb_child_1_year='{$mb_child_1_year}',
                     mb_child_1_month='{$mb_child_1_month}',
                     mb_child_1_day='{$mb_child_1_day}',
                     mb_child_1_sex='{$mb_child_1_sex}',
                     mb_child_2_year='{$mb_child_2_year}',
                     mb_child_2_month='{$mb_child_2_month}',
                     mb_child_2_day='{$mb_child_2_day}',
                     mb_child_2_sex='{$mb_child_2_sex}',
                     mb_child_3_year='{$mb_child_3_year}',
                     mb_child_3_month='{$mb_child_3_month}',
                     mb_child_3_day='{$mb_child_3_day}',
                     mb_child_3_sex='{$mb_child_3_sex}',
                     mb_child_4_year='{$mb_child_4_year}',
                     mb_child_4_month='{$mb_child_4_month}',
                     mb_child_4_day='{$mb_child_4_day}',
                     mb_child_4_sex='{$mb_child_4_sex}',
                     mb_child_5_year='{$mb_child_5_year}',
                     mb_child_5_month='{$mb_child_5_month}',
                     mb_child_5_day='{$mb_child_5_day}',
                     mb_child_5_sex='{$mb_child_5_sex}'
                     {$sql_certify} ";
