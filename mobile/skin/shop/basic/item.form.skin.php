...
<div id="sit_ov_wrap">
    ...
    $thumb = get_it_thumbnail($it['it_img1'], $thumb_img_w, $thumb_img_h);
    if($thumb){
        echo '<div id="sit_pvi">'.PHP_EOL;
		echo "<img src='".G5_URL."/data/item/$it[it_img1]' width='100%' border='0'>";
        echo '</div>';
    }
    ?>
    ...
    <section id="sit_ov">
        ...
        */
        ...
        <div style="width:100%;margin:0 auto;margin-top:5px; background-color: #f9eb00;text-align: center" id="kakao-link-btn">
            <img src="<?php echo G5_URL; ?>/images/gokakao.png" border="0">
        </div>
...
<script>
    ...
    Kakao.init('9be7525f8bcdf48104c781a1f964dd5e');

    // 카카오톡 링크 버튼을 생성합니다. 처음 한번만 호출하면 됩니다.
    Kakao.Link.createTalkLinkButton({
      container: '#kakao-link-btn',
      label: '<?=$it[it_name]?> - WiggleWiggle Smart Gloves',
      image: {
        src: '<?php echo G5_URL."/data/item/$it[it_img1]"; ?>',
        width: '300',
        height: '300'
      },
      webButton: {
        text: '위글위글 장갑 구경하기',
        url: 'http://wiggle-wiggle.com/shop/item.php?it_id=<?=$it_id?>' // 앱 설정의 웹 플랫폼에 등록한 도메인의 URL이어야 합니다.
      }
    });
</script>
